"""
Standalone example runner for battery energy storage optimization
...
def example_basic_optimization():
    ...
    # 6. Create visualizations (comment out if running headless)
    ...
    try:
        ...
        print(f"Skipping plot display (headless mode or error): {e}")
